...
// 게시글 작성
export const createPost = async (data: { title: string; content: string; author: string }): Promise<Post> => {
...
// 댓글 작성
export const createComment = async (postId: string, data: { content: string; author: string }): Promise<Comment> => {
